...
const Horizontal: FC<HorizontalProps> = ({ hideToolbar = false }) => {
          ...
          <div className="card-body">
            ...
            >
              <div className="stepper-nav mb-5">
                ...
                >
                  <h3 className="stepper-title">Study Type</h3>
                </div>

                <div className="stepper-item" data-kt-stepper-element="nav">
                  <h3 className="stepper-title">Study Details</h3>
                </div>

                <div className="stepper-item" data-kt-stepper-element="nav">
                  <h3 className="stepper-title">Study Configuration</h3>
                </div>

                <div className="stepper-item" data-kt-stepper-element="nav">
                  <h3 className="stepper-title">Additional Settings</h3>
                </div>

                <div className="stepper-item" data-kt-stepper-element="nav">
                  <h3 className="stepper-title">Review & Submit</h3>
                </div>
              </div>
