...
const ComparisonForm = ({
  ...
  const [stimuliType, setStimuliType] = useState(
    initialData?.stimuliType || "image"
  );
  ...
  const handleSubmit = async (e) => {
    ...
    const hasStimulus = stimuli.some(
      (stim) => stim.file !== null || stim.preview !== null
    );
    if (!hasStimulus) {
